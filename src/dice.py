...
class Dice:
    ...
    def __init__(self):
        ...
        self.dice_rect = pygame.Rect(WIDTH - 170, HEIGHT / 2, 70, 70)

    def roll(self):
        dice_num1 = random.choice(self.numbers)
        dice_num2 = random.choice(self.numbers)
        self.draw_dice(dice_num1, dice_num2)
